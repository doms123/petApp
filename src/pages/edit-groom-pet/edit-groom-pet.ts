...
@IonicPage()
@Component({
  selector: 'page-edit-groom-pet',
  templateUrl: 'edit-groom-pet.html',
})
export class EditGroomPetPage {
  videoTitle: any;
  videoId: any;
  video: any;
  title: any;
  ...
  constructor(
    ...
    this.editGroomPetVideo = new FormGroup({
